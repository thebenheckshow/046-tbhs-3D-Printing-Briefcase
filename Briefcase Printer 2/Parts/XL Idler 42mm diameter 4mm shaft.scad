...
motor_shaft = 4.25;	// NEMA17 motor shaft exact diameter = 5
m3_dia = 3.2;		// 3mm hole diameter
m3_nut_hex = 1;		// 1 for hex, 0 for square nut
m3_nut_flats = 5.7;	// normal M3 hex nut exact width = 5.6
m3_nut_depth = 2.7;	// normal M3 hex nut exact depth = 2.6, nyloc = 4
...
nut_shaft_distance = 7;	// distance between inner face of nut and shaft, can be negative.
